...
Le mode `fiche` permet d'ajouter et/ou de modifier un `Contact`. Un bouton `Valider` permet d'enregistrer un nouveau `Contact` ou de valider les modifications d'un `Contact` existant.
